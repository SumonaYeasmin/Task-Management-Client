...
const Column = ({ id, title, children }) => {
    ...
    const { data: tasks = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get(`https://task-management-server-six-omega.vercel.app/all-task/${user?.email}`);
...
const Dashboard = () => {
    ...
    const handleAddTask = async (e) => {
        ...
        try {
            const res = await axios.post("https://task-management-server-six-omega.vercel.app/all-task", newTask);
    ...
    const handleDeleteTask = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await axios.delete(`https://task-management-server-six-omega.vercel.app/all-task/${id}`);
    ...
    const updateTask = async (e) => {
        ...
        try {
            const res = await axios.patch(`https://task-management-server-six-omega.vercel.app/all-task/${selectedTask._id}`, updatedTask);
        ...
        if (activeTask.category === targetCategory) {
            ...
            await Promise.all(
                newOrder.map((task, index) =>
                    axios.patch(`https://task-management-server-six-omega.vercel.app/all-task/${task._id}`, { order: index })
                )
            );
            ...
            await axios.patch(`https://task-management-server-six-omega.vercel.app/all-task/${active.id}`, {
